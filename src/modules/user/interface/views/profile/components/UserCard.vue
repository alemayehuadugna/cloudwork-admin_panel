    ...
    <div class="user-bio">
      <div class="user-education user-bio-section">
        <div class="user-bio-section-header">
          <svg-icon name="component" /><span>Description</span>
        </div>
      ...
      <div class="user-education user-bio-section">
        <div class="user-bio-section-header">
          <svg-icon name="hamburger" /><span>Phone</span>
        </div>
        <div class="user-bio-section-body">
          <div class="text-muted">
           <UserModule class="phone"></UserModule>
          </div>
        </div>
...
import PanThumb from "../../../../../../../src/_sharedKernel/components/PanThumb/index.vue";
